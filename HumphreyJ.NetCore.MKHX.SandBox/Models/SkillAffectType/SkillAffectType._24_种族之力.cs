namespace HumphreyJ.NetCore.MKHX.SandBox.Models.SkillAffectType
{
    ...
    {
        public class _24_种族之力 : SkillAffectType
        {
            protected _24_种族之力(string[] AffectValue, string[] AffectValue2) : base(24, AffectValue, AffectValue2)
            {
            ...
            public override string AffectTypeName => "种族之力";

            public override double SkillPercentageAll { get; }

            public override double SkillPercentageMean { get; }

            //  增加场上除自身外我方其他{race}种族（5表示所有、6表示由可选参数{cardId}指定编号的卡牌）卡牌{percentage}%+{number}攻击力。
